...
@section('content')
@php
  $action_url = route('admin.supplier.update',$supplier->id);
@endphp
    <div class="d-flex justify-content-between align-items-center">
        <h2>Cập nhật thương hiệu</h2>
        <a href="{{ route('admin.supplier.index') }}" class="text-decoration-none"><i class="bi bi-box-arrow-left"></i> Trở về</a>
    </div>
