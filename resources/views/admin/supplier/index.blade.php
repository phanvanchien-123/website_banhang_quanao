...
@section('content')
    ...
    <div class="input-group flex-nowrap my-3">
        <div class="d-flex w-100">
            <a href="{{ route('admin.supplier.index') }}" class="btn btn-secondary rounded-0"><i
            ...
            <a href="{{ route('admin.supplier.create') }}" class="text-decoration-none ms-auto text-success"><i
        ...
        <table class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th scope="col">Tên nhà cung cấp <a
                ...
                @foreach ($suppliers ?? [] as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#"
                                onclick="confirmDelete(event, '{{ route('admin.supplier.delete', $item->id) }}')">
