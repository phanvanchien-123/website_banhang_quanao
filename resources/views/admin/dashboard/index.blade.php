        ...
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card tale-bg shadow">
                <div class="weather-info" id="weather" style="z-index: 999">
                    <div class="d-flex">
                        <div>
                            <h2 class="mb-0 font-weight-normal" id="temperature"><i class="icon-sun mr-2"></i></h2>
                        </div>
                        <div class="ml-2">
                            <h6 class="font-weight-normal" id="location"></h6>
                        </div>
                    </div>
                </div>
        ...
        function getWeather(formattedCity) {
            ...
            axios.get(url)
                .then(response => {
                    ...
                    const temperature = `${data.current.temp_c} <sup>C</sup>`;
                    const location = data.location.name;
                    const icon = data.current.condition.icon;

                    // Cập nhật HTML
                    document.getElementById('temperature').innerHTML =
                        `<img src="${icon}" class="weather-icon mr-2" alt="Weather Icon">${temperature}`;
