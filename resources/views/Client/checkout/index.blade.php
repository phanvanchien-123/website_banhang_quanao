                ...
                <form class="needs-validation" method="POST" id="checkoutForm" action="/checkout">
                    ...
                    <div id="billingAddress" class="row g-4">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="address" name="street_address" placeholder="Address">
                        </div>
                        <div class="col-md-3">
                            <label for="city" class="form-label">City</label>
                            <input type="text" class="form-control" id="city" name="town_city" placeholder="City">
                        </div>
                        <div class="col-md-3">
