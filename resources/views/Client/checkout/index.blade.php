...
@if ( Auth::user()->province_id == null || Auth::user()->company_name == null)
    <h1>Khách Hàng vẫn chưa cập nhật tài khoản <a href="/my_account/dashboard">Cập nhật tại đây<i class="fi-rs-arrow-right"></i></a> </h1>
@else
                ...
                @if ($totalItems > 0)
                    ...
                    <form class="needs-validation" method="POST" id="checkoutForm" action="/checkout">
                        ...
                        <div class="d-block my-3">
                            ...
                            <div class="form-check custom-radio-box">
                                <input class="form-check-input" type="radio" name="payment_type" id="debit"
                                    value="1">
                                <label class="form-check-label" for="debit">VNP Payment</label>
                            </div>
                            <div class="form-check custom-radio-box">
                                <input class="form-check-input" type="radio" name="payment_type" id="qrpayment"
                                    value="1">
                    ...
                    <div class="table-responsive order_table text-center">
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ($cartItems as $item)
                                    <tr>
                                        <td class="image product-thumbnail"><img
                                                src="{{ asset('storage/' . $item->product->avatar) }}" alt="#">
                                        </td>
                                        <td>
                                ...
                                <tr>
                                    <th>SubTotal</th>
                                    <td class="product-subtotal" colspan="2">{{ number_format($totalPrice, 3) }}
                                        VND</td>
                                </tr>
                                <tr>
                                    <th>Shipping</th>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        ...
                                        <button id="removeCouponButton" type="button" style="display: none;">Hủy bỏ
                                            mã giảm giá</button>
                                ...
                                <tr>
                                    <th>Giảm Giá</th>
                                    <td colspan="2" id="discountAmount">{{ number_format($discount ?? 0, 3) }} VND
                                    </td>
                                </tr>
                                <tr>
                                    <th>Total</th>
