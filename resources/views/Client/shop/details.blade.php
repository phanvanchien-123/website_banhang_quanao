...
.color-picker input[type="radio"]:checked + label {
  /* Adjust the opacity value to change the faded effect */
    content: "\2713";
    font-size: 20px;
    transform: translate(10%, 10%); /* Center the checkmark */
                            ...
                            <div class="cloth-details-size">
                                ...
                                <div id="selectSize" class="addeffect-section product-description border-product">
                                   ...
                                   <div class="image-select">
                                    ...
                                    @else
                                    <h6 class="product-title product-title-2 d-block">Còn : {{$quantity}} Sản phẩm </h6>
                                    @endif
                                    @endif
                                ...
                                <div class="product-buttons">
                                    ...
                                    <button type="button" id="cartEffect" class="btn btn-solid hover-solid btn-animation" onclick="addToCart({{ $products->id }})">
...
<section class="ratio_asos section-b-space overflow-hidden">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="mb-lg-4 mb-3">Sản Phẩm Tương Tự</h2>
                        ...
                        <div class="product-box">
                            ...
                            <div class="product-details">
                                <div class="rating-details">
                                    <span class="font-light grid-content">{{$item->tag}}</span>
                                ...
                                <div class="main-price">
                                    <a href="details.php" class="font-default">
                                        <h4 class="theme-color">{{$item->name}}</h4>
                                    </a>
                                
                                    <h4 class="price-detail">

                                        @if ($item->discount)
                                        {{number_format($item->discount,3)}} VND
